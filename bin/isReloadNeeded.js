function reloadOnNeed () {
    ...
    if(dateActuelle.getTime() - dateCreation.getTime() > 60000*3) {
        var promise = $.getJSON("htmlGenerator.php");
        ...
        //info.innerHTML += phpVars[0];
        file = fopen("newsfeed.html", 3);
        fwrite(file, phpVars[text]);
